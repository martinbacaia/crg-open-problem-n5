...
if __name__ == "__main__":
    ...
    with open("S115_familia2_fast.pkl", "rb") as f:
        ref15 = pickle.load(f)
    ...
    for idx in range(15):
        ...
        if not match:
            ok = False
            print(f"S{idx+1}: MISMATCH vs S115_familia2_fast.pkl")
    print("S1..S15 coinciden con S115_familia2_fast.pkl:", ok)

    lo16 = totals[15].lowest_order()
    print(f"S16: lowest order = {lo16}, is_zero = {totals[15].is_zero()}")

    with open("S116_familia2.pkl", "wb") as f:
