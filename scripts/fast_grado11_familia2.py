"""
Version RAPIDA (lseries.py) de regge_n5_familia2_grado11.py (S1..S15, familia 2, jerarquica).
Compara contra S115_familia2.pkl (ya calculado con el pipeline sympy original) coeficiente a
coeficiente antes de confiar en el resultado.
"""
...
if __name__ == "__main__":
    ...
    with open("S115_familia2_fast.pkl","wb") as f:
